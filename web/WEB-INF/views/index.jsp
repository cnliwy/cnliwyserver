...
<head>
	...
	<link rel="stylesheet" href="${basePath}/css/jquery.vegas.css" />
	<link rel="stylesheet" href="${basePath}/css/baraja.css" />
	...
	<link rel="stylesheet" id="scheme-source" href="${basePath}/css/schemes/gray.css" />
	...
	<div id="header" class="header-section">
		...
		<div id="section-home" class="home-section-wrap center">
			...
			<div class="container home">
				<div class="row">
					<h1 class="well-come">Easy Life</h1>
					
					<div class="col-md-8 col-md-offset-2">
						<p class="intro-message">快乐不是一个简单的事，但简单是一件快乐的事</p>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 service animated" data-animation="fadeInLeft" data-animation-delay="700">
					...
					<div class="service-desc">
						<h4 class="service-title color-scheme">来点儿音乐</h4>
				...
				<div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
					...
					<div class="service-desc">
						<h4 class="service-title color-scheme">开心一刻</h4>
						<p class="service-description justify">
							Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
							Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
						</p>
				...
				<div class="col-md-6 col-sm-6 service animated" data-animation="fadeInRight" data-animation-delay="700">
					...
					<div class="service-desc">
						<h4 class="service-title color-scheme">生活工具</h4>
						<p class="service-description justify">
							Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
							Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
						</p>
				...
				<div class="col-md-6 col-sm-6 service animated" data-animation="fadeInUp" data-animation-delay="700">
					...
					<div class="service-desc">
						<h4 class="service-title color-scheme">享受生活</h4>
						<p class="service-description justify">
							Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
							Cillum laboris consequat, qui elit retro next level skateboard freegan hella.
						</p>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="social-icons">
						<ul>
							<li><a href="#"><i class="fa fa-facebook-square"></i>百度</a></li>
							<li><a href="#"><i class="fa fa-twitter-square"></i>google</a></li>
							<li><a href="#"><i class="fa fa-google-plus-square"></i>腾讯</a></li>
							<li><a href="#"><i class="fa fa-pinterest-square"></i>阿里巴巴</a></li>
							<li><a href="#"><i class="fa fa-flickr"></i></a>微软</li>
							<li><a href="#"><i class="fa fa-linkedin-square">facebook</i></a></li>
						</ul>
					</div>
					
					<p class="copyright">All rights reserved &copy; 2017.暮醉南山</p>
				</div>
			</div>
		</div>
	</div>
